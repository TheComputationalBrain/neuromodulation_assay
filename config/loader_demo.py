from config.demo.params_config import load_params
from config.demo.paths_config import load_paths
from config.demo.receptor_config import load_receptors
from config.utils import AttrDict


def load_config(task: str, source="PET", cv=False, return_what="all"):
    """
